...
curl --data '{"jsonrpc":"2.0","method":"eth_getBalance","params":["{{ authority_nodes_dict[k][0] }}", "latest"],"id":1}' -H "Content-Type: application/json" -X POST {{ ip_nodes_dict["h0"][0] }}:8540
